...
max_legend_height = 0.25    # Fraction of canvas height
...
tt_bla.DrawTextNDC(0.21, 0.95, "CMS simulation")
tt_wip = ROOT.TText()
tt_wip.SetTextFont(63)
tt_wip.SetTextSizePixels(25)
tt_wip = tt_wip.DrawTextNDC(0.21, 0.91, "work in progress")
'''
